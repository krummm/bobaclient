...
void helpOutput() {
        ...
        printf("%s\n", "- 'u z' in the parent directory of the folder you would like to upload all files to bobashare as a .zip and return the URL.");
        printf("%s\n", "- 'u z r' does the same as 'bobaclient u z', with a randomized filename.");
        printf("%s\n", "");
